// plane helpers
import { convertHexEmojiToDecimal } from '../../../../utils/emoji';
// plane ui
import {
  EmojiIconPicker,
...
export const CalloutBlockLogoSelector: React.FC<Props> = (props) => {
  const { blockAttributes, disabled, handleOpen, isOpen, updateAttributes } =
    props;
  ...
  return (
    <div contentEditable={false}>
      <EmojiIconPicker
        ...
        buttonClassName={cn(
          'flex-shrink-0 size-8 grid place-items-center rounded-lg',
          {
