...
export const CalloutBlockColorSelector: React.FC<Props> = (props) => {
  ...
  return (
    <div
      className={cn(
        'opacity-0 pointer-events-none absolute top-2 right-2 z-10 transition-opacity',
        {
          'group-hover/callout-node:opacity-100 group-hover/callout-node:pointer-events-auto':
            !disabled,
