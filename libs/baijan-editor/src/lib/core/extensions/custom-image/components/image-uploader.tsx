...
// extensions
import { CustoBaseImageNodeViewProps, getImageComponentImageFileMap } from '..';
...
export const CustomImageUploader = (props: CustomImageUploaderProps) => {
  ...
  // derived values
  const imageComponentImageFileMap = useMemo(
    () => getImageComponentImageFileMap(editor),
    [editor]
  );
  ...
  const onUpload = useCallback(
    (url: string) => {
      if (url) {
        ...
        if (
          currentNode &&
          currentNode.type.name === 'imageComponent' &&
