...
export type TCommandWithProps<T extends TEditorCommands> =
...
type TCommandWithPropsWithItemKey<T extends TEditorCommands> =
  T extends keyof TCommandExtraProps
...
export interface EditorRefApi extends EditorReadOnlyRefApi {
  ...
  isMenuItemActive: <T extends TEditorCommands>(
    props: TCommandWithPropsWithItemKey<T>
  ) => boolean;
...
export interface ICollaborativeDocumentEditor
  extends Omit<
    IEditorProps,
    'initialValue' | 'onChange' | 'onEnterKeyPress' | 'value'
  > {
...
export interface ICollaborativeDocumentReadOnlyEditor
  extends Omit<IReadOnlyEditorProps, 'initialValue'> {
  embedHandler: TEmbedConfig;
  handleEditorReady?: (value: boolean) => void;
  id: string;
  realtimeConfig: TRealtimeConfig;
