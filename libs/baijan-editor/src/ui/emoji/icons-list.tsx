      ...
      <div className="flex flex-col sticky top-0 bg-custom-background-100">
        {!searchDisabled && (
          <div className="flex items-center px-2 py-[15px] w-full ">
            <div
              className={`relative flex items-center gap-2 bg-custom-background-90 h-10 rounded-lg w-full px-[30px] border ${
                isInputFocused
        ...
        <div className="grid grid-cols-9 gap-2 items-center justify-items-center px-2.5 py-1 h-9">
          {showHexInput ? (
            <div className="col-span-8 flex items-center gap-1 justify-self-stretch ml-2">
              ...
              />
              <span className="text-xs text-custom-text-300 flex-shrink-0">
                HEX
              </span>
              <span className="text-xs text-custom-text-200 flex-shrink-0 -mr-1">
                #
              </span>
              <Input
                type="text"
          ...
          <button
            type="button"
            className={cn(
              'grid place-items-center h-4 w-4 rounded-full border border-transparent',
              {
          ...
          >
            {showHexInput ? (
              ...
              <span className="text-custom-text-300 text-[0.6rem] grid place-items-center">
                #
              </span>
            )}
          </button>
