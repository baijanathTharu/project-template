          ...
          <Popover.Panel className="fixed z-10" static>
            ...
            >
              <Tab.Group
                ...
                defaultIndex={TABS_LIST.findIndex(
                  (tab) => tab.key === defaultOpen
                )}
              >
                <Tab.List as="div" className="grid grid-cols-2 gap-1 p-2">
                  {TABS_LIST.map((tab) => (
                    <Tab
                      ...
                      className={({ selected }) =>
                        cn(
                          'py-1 text-sm rounded border border-custom-border-200',
                          {
                            'bg-custom-background-80': selected,
                            'hover:bg-custom-background-90 focus:bg-custom-background-90':
                              !selected,
                          }
                        )
                      }
